...
export class Blub extends Page {
    ...
    content() {
        return `<div class="tisch">our html content ddd</div>
<div class="tisch">our html content ddd
</div>
<div class="tisch">our html content ddd</div>
<div class="tisch">our html content ddd</div>
<div class="tisch">our html content ddd</div>
<div class="tisch">our html content ddd</div>
<div class="tisch">our html content ddd</div>`;
    ...
    onMount() {
        ...
        $(".tisch").click(function(){
            alert("hi");
            $(".tisch").append(`<span class="redAndBig">hey</span>`);
        });
